...
//             console.log(`Rate limit reached after ${count} requests.`);
//             return;
//         }

//         count++;
//         if (count % 10 === 0) {
//             console.log(`${count} requests made successfully...`);
//         }

//         setTimeout(makeRequest, 100); // 100ms delay
//     } catch (error) {
...
//   <rect width="1200" height="800" fill="#F0F4F7" />
//   <text x="600" y="400" font-size="24" text-anchor="middle" fill="#0072BC">
//     Sample SVG Visual Abstract
//   </text>
// </svg>`;
...
//         parts: [
//           {
//             text: `fit this pdf into the svg and return the updated svg code
// ${svgContent}`
//           },
//           {
//             inlineData: {
...
//   const tmpFile = path.join('/tmp', `payload-${Date.now()}.json`);
...
//     count++;
//     console.log(`${count} request(s) made successfully...`);
//     await fs.unlink(tmpFile); // clean up temp file
//     setTimeout(makeRequest, 100); // 100ms delay
//   } catch (error) {
//     console.error(`Request failed: ${error.message}`);
//     await fs.unlink(tmpFile); // clean up temp file even on error
//   }
// }

// makeRequest();

// // /Users/rajvanshmalhotra/Documents/med.pdf
// import { exec } from 'child_process';
// import { promisify } from 'util';
// import fs from 'fs/promises';
// import path from 'path';
...
// const execAsync = promisify(exec);
// const apiKey = 'AIzaSyCYSohdlBCPVjgEEsrq9GBwgroCn7OGwNI';
// const url1 = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent';
// // const url2 = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent'; // update if second endpoint differs
...
// async function makeSingleApiCall(url, pdfBase64, label) {
//   const payload = {
//     contents: [
//       {
//         parts: [
...
//     if (response.error && response.error.code === 429) {
//       console.log(`Rate limit reached after ${count} successful requests.`);
//       process.exit(0);
//     }

//     count++;
//     console.log(`${count} successful request(s) so far (${label})`);
//   } catch (error) {
//     console.error(`Request failed (${label}): ${error.message}`);
//     await fs.unlink(tmpFile); // clean up even on error
//   }
// }
// async function makeRequestsLoop() {
//   const pdfBase64 = await fs.readFile(pdfPath, { encoding: 'base64' });
//     // console.log("the pdf path",pdfBase64);
//   while (true) {
//     await makeSingleApiCall(url1, pdfBase64, 'API-1');
//     await new Promise((resolve) => setTimeout(resolve, 1)); // 100ms delay between loops
//   }
// }
